...
<article>
  ...
  <blockquote>
    ...
    <footer>Toby Adams, director of the Edible Academy at the New York Botanical Garden, said in an interview.</footer>
  </blockquote>
  
  <section>
  	<h3>Tomato</h3>
    <p>Although they're technically a fruit, tomatoes have been legally defined as vegetables in the US.</p>
  </section>
  ...
  <footer>
  	<h4>Reference</h4>
    <ul>
      <li><a href="https://www.insider.com/fruits-that-are-vegetables-2018-12#eggplants-are-botanically-classified-as-berries-8">10 'fruits' that are technically vegetables — and vice versa</a></li>
    </ul>
  </footer>
</article>
...
The `group` element, as its name suggests, is used to group related headings. For example:
...
When a user then browses by landmarks, the above landmark will then be identified and read out as follows:
...
The guiding principal is that the `address` element represents contact information for its closest `article` or `body` element. Let us look at the landing page for a publication as an example:
...
<article>
	...
	<p>Some interesting info about the unknown pony. <a href="/pony">Read more</a></p>
	<p>Written by: <address><a href="mailto:pete@horseandhound.com">Peter Horse</a></address></p>
</article>

<article>
	<h2>The Maltchi</h2>
	<p>Some interesting info about the Maltchi. <a href="/malchi">Read more</a></p>
	<p>Written by: <address><a href="mailto:sally@horseandhound.com">Sally Hound</a></address></p>
</article>

<footer>
	<address><a href="mailto:info@horseandhound.com">Horse And Hound HQ</a></address>
</footer>
</body>
```
...
And with that, we have covered all the sectioning element in HTML. Next we will dive into grouping content, touching on elements we use very frequently on a day to day basis. Until then, keep making the web awesome! 🧐
...
- [Update outline algorithm](https://github.com/w3c/html/issues/794)
- [Add heading-focused outlines and :heading](https://github.com/whatwg/html/pull/3499)
- [Visualise your document outline with the HTML5 Validator in outline mode](https://validator.w3.org/nu/)
